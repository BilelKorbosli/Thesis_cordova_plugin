    ...
    if (cordova.platformId === "android" || cordova.platformId === "windows") {
        setTimeout(
            function () {
                cordova.exec(
                    function () {
                        console.log("Initialized the FreeStyleLibrePlugin");
                    },
                    function (reason) {
                        console.log("Failed to initialize the FreeStyleLibrePlugin " + reason);
                    },
                    "FreeStyleLibrePlugin", "init", []
                );
            }, 10
        );
    }
...
var nfc = {
    ...
    addTagDiscoveredListener: function (callback, win, fail) {
        ...
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "registerTag", []);
    },

    addMimeTypeListener: function (mimeType, callback, win, fail) {
        document.addEventListener("ndef-mime", callback, false);
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "registerMimeType", [mimeType]);
    },

    addNdefListener: function (callback, win, fail) {
        document.addEventListener("ndef", callback, false);
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "registerNdef", []);
    },

    addNdefFormatableListener: function (callback, win, fail) {
        document.addEventListener("ndef-formatable", callback, false);
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "registerNdefFormatable", []);
    },

    write: function (ndefMessage, win, fail) {
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "writeTag", [ndefMessage]);
    },

    makeReadOnly: function (win, fail) {
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "makeReadOnly", []);
    },

    share: function (ndefMessage, win, fail) {
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "shareTag", [ndefMessage]);
    },

    unshare: function (win, fail) {
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "unshareTag", []);
    },
    ...
    handover: function (uris, win, fail) {
        ...
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "handover", uris);
    },

    stopHandover: function (win, fail) {
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "stopHandover", []);
    },

    erase: function (win, fail) {
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "eraseTag", [[]]);
    },

    enabled: function (win, fail) {
        return cordova.exec(win, fail, "FreeStyleLibrePlugin", "enabled", [[]]);
    },

    removeTagDiscoveredListener: function (callback, win, fail) {
        document.removeEventListener("tag", callback, false);
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "removeTag", []);
    },

    removeMimeTypeListener: function(mimeType, callback, win, fail) {
        document.removeEventListener("ndef-mime", callback, false);
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "removeMimeType", [mimeType]);
    },

    removeNdefListener: function (callback, win, fail) {
        document.removeEventListener("ndef", callback, false);
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "removeNdef", []);
    },
    ...
    connect: function(tech, timeout) {
        return new Promise(function(resolve, reject) {
            cordova.exec(resolve, reject, 'FreeStyleLibrePlugin', 'connect', [tech, timeout]);
        });
    },

    close: function() {
        return new Promise(function(resolve, reject) {
            cordova.exec(resolve, reject, 'FreeStyleLibrePlugin', 'close', []);
        });
    },
    //convert hex buffer to int
    glucoseConvert: function(win,fail,buffer) {
        cordova.exec(win, fail, "FreeStyleLibrePlugin", "GLUCOSE_CONVERT", [buffer]);
    },
    ...
    transceive: function(data) {
        return new Promise(function(resolve, reject) {
            ...
            cordova.exec(resolve, reject, 'FreeStyleLibrePlugin', 'transceive', [buffer]);
        });
    },
    dumpData: function(){
        return new Promise(function(resolve,reject){
            cordova.exec(resolve, reject, 'FreeStyleLibrePlugin', 'dumpData',[]);
        });
    ...
    readerMode: function(flags, readCallback, errorCallback) {
        cordova.exec(readCallback, errorCallback, 'FreeStyleLibrePlugin', 'readerMode', [flags]);
    },

    disableReaderMode: function(successCallback, errorCallback) {
        cordova.exec(successCallback, errorCallback, 'FreeStyleLibrePlugin', 'disableReaderMode', []);
    }
...
require('cordova/channel').onCordovaReady.subscribe(function() {
  require('cordova/exec')(success, null, 'FreeStyleLibrePlugin', 'channel', []);
